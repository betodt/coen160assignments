...
class BarCharts extends JPanel
{
	...
	{         
    	Font font = new Font("Comic Sans MS",Font.PLAIN,28);
	     ...
	     if(firstTime) {
	    	 g.drawString( "Expense",(getWidth() - (g.getFontMetrics(font)).stringWidth("Expense"))/2, (getHeight() - (g.getFontMetrics(font)).getHeight())/2 );
		     g.drawString( "Tracker",(getWidth() - (g.getFontMetrics(font)).stringWidth("Tracker"))/2, (getHeight() + (g.getFontMetrics(font)).getHeight())/2 );
		     firstTime = false;
	     } else {
	    	 
		     g.drawString( "You exceeded",(getWidth() - (g.getFontMetrics(font)).stringWidth("You exceeded"))/2, (getHeight() - (g.getFontMetrics(font)).getHeight())/2 );
		     g.drawString( "your limit!",(getWidth() - (g.getFontMetrics(font)).stringWidth("your limit!"))/2, (getHeight() + (g.getFontMetrics(font)).getHeight())/2 );
